...
export const getCourseProgress=async(req,res)=>{
    try {
      ...
      // step3: return user's course progress along with course details
      return res.status(200).json({
        data:{
            courseDetails,
...
export const updateLectureProgress=async(req,res)=>{
    try {
        ...
        const lectureProgressLength=courseProgress.lectureProgress.filter((lectureP)=> lectureP.viewed).length
