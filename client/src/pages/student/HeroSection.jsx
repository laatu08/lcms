  ...
  return (
    <div className='relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark::from-gray-800 dark::to-gray-900 py-24 px-4 text-center'>
        <div className='max-w-3xl mx-auto'>
            ...
            <p className='text-gray-200 dark:text-gray-400 mb-8'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit eos iure tenetur placeat ea?</p>
            ...
            <form action="" className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6'>
                <Input type="text" className="flex-grow border-none focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500" placeholder="Search Courses"></Input>
