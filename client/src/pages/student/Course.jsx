      ...
      <CardContent className="px-5 py-4 space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-medium text-sm">Partha Academy</h1>
          </div>
          <Badge className="bg-blue-600 text-white px-2 py-1 text-xs rounded-full">Mythical</Badge>
        </div>
